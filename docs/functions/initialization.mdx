...
- Vue [see this guide](https://angular.io/guide/service-worker-getting-started)
- Angular [see this guide](https://www.360learntocode.com/2020/12/how-to-use-and-customize-service-worker-in-vuejs-pwa.html)
