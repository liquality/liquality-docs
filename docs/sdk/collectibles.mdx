...
:::info
In order to use the `getNfts()` function you will need to have called the `sdk.setup()` function and provide valid API keys. [See here](https://docs.liquality.io/sdk/initialization#setup-api-keys)
:::
