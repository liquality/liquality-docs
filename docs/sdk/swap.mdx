...
```typescript
swap(swapRequest: SwapRequest, pk: string)
```

The swap() function takes the private key string and an object that we call SwapRequest and it has the following object properties:
